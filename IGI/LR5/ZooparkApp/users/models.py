...
class Position(models.Model):
    ...
    description = models.CharField(max_length=200, default="Hard work", verbose_name="Описание")
...
class Employee(models.Model):
    ...
    image = models.ImageField(upload_to='images/', default='images/avatar.jpg', verbose_name="Фото")
    class Meta:
