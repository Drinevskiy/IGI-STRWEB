...
def dictionary_of_vowel_consonant_equal(list_of_string):
    """
    Returns a dictionary of words with the same number of consonants and vowels and their indexes.
    ...
    while index < length:
        ...
        consonant_count = len([letter for letter in word if letter not in vowels])
...
def task4():
    ...
    print("Dictionary(key - word, value - index) of words with the same number of consonants and vowels and their indexes.")
